        ...
        return (
            <>
                <div className="head-R">
                    <img src="https://logos-world.net/wp-content/uploads/2020/11/Gmail-Logo.png" al="google-logo" />
                </div>
                    ...
                    <form  className="form frm-w bg-info p-4 m-auto mb-5">
                        ...
                        <div>
                            ...
                            <a href="https://accounts.google.com/signin/v2/identifier?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&service=mail&sacu=1&rip=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin" target="_blank" className="btn btn-light ms-3">Login</a>
                        </div>
